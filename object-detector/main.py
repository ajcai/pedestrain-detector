...
def batch():
    ...
    for ort in orient:
        ...
        process_set('../data/detections/detections_orient_{}.data'.format(ort))
    ...
    for sz in cell_sz:
        ...
        process_set('../data/detections/detections_cell_{}{}.data'.format(sz[0],sz[1]))
    ...
    for sz in block_sz:
        ...
        process_set('../data/detections/detections_block_{}{}.data'.format(sz[0],sz[1]))
    ...
    for n in norm_type:
        ...
        process_set('../data/detections/detections_norm_{}.data'.format(n))
